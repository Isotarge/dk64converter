...
namespace BigEndian
{
    ...
    public static class BigEndian
    {
        //PUBLIC METHODS
        #region READ
        public static void read<T>(out T output, IEnumerable<byte> input, int offset = 0) { output = read<T>(input, offset); }
        public static T read<T>(IEnumerable<byte> input, int offset = 0)
        {
        ...
        public static void read_array<T>(IEnumerable<byte> input, ref T[] output, int offset = 0)
        {
        ...
        public static T[] read_array<T>(IEnumerable<byte> input, int length, int offset = 0)
        {
        ...
        public static int size<T>(T typedVal) { return size<T>(); }
        ...
        public static byte[] write_array<T>(T[] value)
        {
        ...
        public static void write_array<T>(T[] value, ref byte[] output, int offset = 0)
        {
            int ref_off = offset;
            _writeArray(value, ref output, ref ref_off);
            return;
        ...
        private static T _read<T>(IEnumerable<byte> input, ref int offset)
        {
            dynamic output = 0;
        ...
        private static T _size<T>(IEnumerable<byte> input, ref int offset)
        {
        ...
        private static void _readArray<T>(IEnumerable<byte> input, ref T[] output, ref int offset, MethodInfo prim_f)
        {
        ...
        private static void _writeArray<T>(T[] value, ref byte[] output, ref int offset)
        {
